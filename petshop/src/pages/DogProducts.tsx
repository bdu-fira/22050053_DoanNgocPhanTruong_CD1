...
const DogProducts = () => {
  ...
  useEffect(() => {
    // Filter products for dogs
    let filteredProducts = PRODUCTS.filter(p => p.category === 'dog');
  ...
  return (
    <div className="py-12">
      <div className="container mx-auto px-4">
        <h1 className="text-3xl md:text-4xl font-bold mb-8">Chó</h1>
        
        <div className="mb-8">
          <Tabs defaultValue={typeFilter || "all"}>
            <TabsList className="mb-8">
              <TabsTrigger value="all">Tất cả sản phẩm</TabsTrigger>
              <TabsTrigger value="food">Chó</TabsTrigger>
